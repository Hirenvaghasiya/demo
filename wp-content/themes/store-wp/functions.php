...
function store_wp_setup() {
     ...
     * If you're building a theme based on Store WP, use a find and replace
...
function store_wp_content_width() {
    $GLOBALS['content_width'] = apply_filters( 'store_wp_content_width', 1040 );
}
...
function store_wp_google_fonts() {
        wp_enqueue_style( 'store-wp-fonts', '//fonts.googleapis.com/css?family='. apply_filters( 'igthemes_google_font', 'Open+Sans:400,400i,700,700i&subset=latin-ext'));
}
