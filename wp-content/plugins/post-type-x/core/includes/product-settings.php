...
function ic_bug_report() {
	...
	__( 'Do you have a problem?', 'post-type-x' ) . '</div>
		...
		<div class="doc-button"><a href="https://wordpress.org/support/plugin/post-type-x"><input class="doc_button classic-button" type="button" value="' . __( 'Report a Problem', 'post-type-x' ) . '"></a></div>
		<a title="' . __( 'Click the button to visit support forum.', 'post-type-x' ) . '" href="https://wordpress.org/support/plugin/post-type-x" class="background-url"></a>
		</div></div>';
	echo $helper;
}
